...
def main():
    ...
    act_cycle = [c for c, on in ((0, args.silu), (1, args.relu2), (2, args.normsilu), (5, args.situ), (6, args.nsr)) if on]
    assert act_cycle, "enable at least one of --silu/--relu2/--normsilu/--situ/--nsr"
    ...
    acts_tag = "".join(n for n, on in (("s", args.silu), ("r", args.relu2), ("n", args.normsilu), ("t", args.situ), ("R", args.nsr)) if on)
